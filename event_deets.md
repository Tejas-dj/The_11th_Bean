...
type: 'collab',
date: '2026-05-10',
time: 'Flexible Start – 3-Week League',
venue: 'The 11th Bean, Basavanagudi / Jayanagar',
description: 'A structured 3-week pickleball league with two tiers, rankings, playoffs, and DUPR tracking. Limited to 60 players.',
longDescription: `We're going beyond the one-day tournament format — introducing The 11th Bean Pickleball League, Season 1.\n\nThe league runs over 3 weeks with matches played to 11, a full rankings system, and playoffs to crown the champions. We're running two competitive tiers: Prathama (Top League) and Dwitheeya (Challenger League), with promotion for top performers and relegation for the bottom — keeping every match meaningful.\n\nDUPR tracking support is included, so your performance counts toward your official rating. Trophies, medals, and cash prizes are on the line.\n\nEntry is ₹999 per player (not per team). Spots are strictly limited to 60 players — DM "IN" on 8105585901 to join.`,
tags: ['sport', 'pickleball', 'league', 'competitive'],
status: 'upcoming',
accentColor: '#2A4A22',
mascot: '/mascot/pickleball.svg',
rsvpLink: 'https://wa.me/918105585901',
poster: '/event_posters/pickleball_league_s1.png',
}
